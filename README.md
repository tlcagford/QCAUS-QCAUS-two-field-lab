...
QCAUS v4.0 in this edition is **not** the old 20-pipeline Streamlit suite, **not** a magnetar / stellar lab, and **not** a dark-photon modem. It is a proof-of-concept analog that does two jobs:
